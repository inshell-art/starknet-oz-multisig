...
This scaffold is not a runnable system. The scripts in `ops/tools/` are stubs that intentionally fail until you implement them for your repo.
...
2. Replace stubs in `ops/tools/` with your real commands.
